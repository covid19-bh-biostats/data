...
# Read datasets
data1 <- read.csv("Spain/nacional_covid19.csv") # National number of cases, deaths, hopitalised and UCI patients by day
data2 <- read.csv("Spain/nacional_covid19_rango_edad.csv") # By age group and sex
...
write.csv(data1, file = "Spain/nacional_covid19.csv", row.names = FALSE)
write.csv(data2, file = "Spain/nacional_covid19_rango_edad.csv", row.names = FALSE)
